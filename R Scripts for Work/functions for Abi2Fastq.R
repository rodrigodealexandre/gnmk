...
SequenceQualityControl <- function(AbiFile){
  ...
  print(c(paste("Data de criação do arquivo: ",Abi[3][[1]]$RUND.4[3],"/",Abi[3][[1]]$RUND.4[2],"/",Abi[3][[1]]$RUND.4[1],
  ...
  print(c(paste("Nome do arquivo:",Abi[3][[1]]$SMPL.1), paste("Nome do arquivo:",Abi[3][[1]]$SMPL.1), paste("Checagem de qualidade QV20:",Abi[3][[1]]$CRLn.2),
          paste("Qualidade média da primeira leitura:", round(mean(qual1),2)),
          paste("Qualidade média da segunda leitura:",round(mean(qual2),2)),
